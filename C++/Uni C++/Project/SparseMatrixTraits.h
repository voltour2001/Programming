...
#define MAX_COORD 100000 // MAX_COORD: Η μέγιστη δυνατή διάσταση του πίνακα. 
...
template <typename T>
static const T & getNullElement() { static const T _null_element = T(); return _null_element; }
